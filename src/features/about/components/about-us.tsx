      ...
      <div className="flex lg:flex-row flex-col justify-between md:gap-14 gap-6">
        ...
        <div className="flex flex-col gap-32 basis-[60%]">
          <div className="md:space-y-6 space-y-4">
            <h3 className="font-semibold xl:text-base text-xs">ABOUT US</h3>
            <h1 className="xl:text-[64px] text-2xl xl:leading-[72px] font-bold bg-gradient-to-r from-white to-ip-gray-500 bg-clip-text text-transparent leading-normal">
              Impact Palu is a social entrepreneurship incubator based in Palu.
            </h1>
            <p className="xl:text-xl xl:leading-8 text-sm leading-5">
